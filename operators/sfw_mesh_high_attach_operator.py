...
class OBJECT_OT_SfwMeshHighAttach(bpy.types.Operator):
    bl_idname = "high_poly_sfw.attach"
    bl_label = "Attach high poly sfw mesh"
    ...
    def execute(self, context):
        ...
        if active_obj and active_obj.type == 'MESH':
            ...
            # Check if the "NSFW" vertex group exists
            nsfw_group = active_obj.vertex_groups.get("NSFW")
            ...
            if nsfw_group:
                ...
                # Select faces in the "NSFW" group
                bpy.ops.object.mode_set(mode='EDIT')
                bpy.ops.object.vertex_group_set_active(group="NSFW")
                ...
                print("Vertex group 'NSFW' not found.")
                self.report({'ERROR'}, "Vertex group NSFW not found.")
                return {'CANCELLED'}
        else:
        ...
        file_path = os.path.join(parent_dir, "high_sfw.fbx")
