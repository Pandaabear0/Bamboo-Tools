...
class OBJECT_OT_SfwMeshLowAttach(bpy.types.Operator):
    bl_idname = "low_poly_sfw.attach"
    bl_label = "Attach low poly sfw mesh"
    ...
    def execute(self, context):
        ...
        file_path = os.path.join(parent_dir, "low_sfw.fbx")
