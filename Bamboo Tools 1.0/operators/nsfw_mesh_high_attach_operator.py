...
class OBJECT_OT_NsfwMeshHighAttach(bpy.types.Operator):
    bl_idname = "high_poly_nsfw.attach"
    bl_label = "Attach high poly nsfw mesh"
    ...
    def execute(self, context):
        ...
        file_path = os.path.join(parent_dir, "high_vagina.fbx")
